...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skill.free_123_spells'
        db.add_column('chars_skill', 'free_123_spells',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Skill.free_456_spells'
        db.add_column('chars_skill', 'free_456_spells',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Skill.free_789_spells'
        db.add_column('chars_skill', 'free_789_spells',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skill.free_123_spells'
        db.delete_column('chars_skill', 'free_123_spells')

        # Deleting field 'Skill.free_456_spells'
        db.delete_column('chars_skill', 'free_456_spells')

        # Deleting field 'Skill.free_789_spells'
        db.delete_column('chars_skill', 'free_789_spells')
