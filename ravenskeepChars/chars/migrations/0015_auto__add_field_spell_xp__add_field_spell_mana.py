...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Spell.xp'
        db.add_column('chars_spell', 'xp',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Spell.mana'
        db.add_column('chars_spell', 'mana',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Spell.xp'
        db.delete_column('chars_spell', 'xp')

        # Deleting field 'Spell.mana'
        db.delete_column('chars_spell', 'mana')
