...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.first_live_nr_mana'
        db.add_column('chars_character', 'first_live_nr_mana',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.first_live_nr_mana'
        db.delete_column('chars_character', 'first_live_nr_mana')
