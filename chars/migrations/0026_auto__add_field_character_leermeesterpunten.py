...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.leermeesterpunten'
        db.add_column('chars_character', 'leermeesterpunten',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.leermeesterpunten'
        db.delete_column('chars_character', 'leermeesterpunten')
