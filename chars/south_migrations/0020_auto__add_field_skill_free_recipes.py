...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skill.free_recipes'
        db.add_column('chars_skill', 'free_recipes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skill.free_recipes'
        db.delete_column('chars_skill', 'free_recipes')
    ...
    models = {
        ...
        'chars.skill': {
            ...
            'free_recipes': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'naam': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
