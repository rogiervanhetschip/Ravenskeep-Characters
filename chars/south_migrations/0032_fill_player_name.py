...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for player in orm.Player.objects.all():
          player.name = self.naam(player)
          player.save()

    def naam(self, player):
      if player.tussenvoegsels == None or player.tussenvoegsels == '':
        return player.voornaam + " " + player.achternaam
      return player.voornaam + " " + player.tussenvoegsels + " " + player.achternaam
