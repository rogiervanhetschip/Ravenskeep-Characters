...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.has_mana'
        db.add_column('chars_character', 'has_mana',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Skill.gives_mana'
        db.add_column('chars_skill', 'gives_mana',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.has_mana'
        db.delete_column('chars_character', 'has_mana')

        # Deleting field 'Skill.gives_mana'
        db.delete_column('chars_skill', 'gives_mana')
